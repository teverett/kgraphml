...
public class GraphMLMarshaller {
	...
	public static void exportGraph(GraphmlType graphmlType, OutputStream outputStream) throws IOException, JAXBException {
	...
	public static GraphmlType importGraph(InputStream inputStream) throws IOException, JAXBException {
		if (null != inputStream) {
			final JAXBContext jc = JAXBContext.newInstance(PACKAGE);
			final Unmarshaller unmarshaller = jc.createUnmarshaller();
			@SuppressWarnings("unchecked")
			final JAXBElement<GraphmlType> je = (JAXBElement<GraphmlType>) unmarshaller.unmarshal(inputStream);
			return je.getValue();
		} else {
			return null;
		}
